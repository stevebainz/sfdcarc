...
namespace SFDC_API_Demo
{
    public class Program
    {
        ...
        {
            bool isLoggedIn = loginSample();
            createAccount();
            queryRecords();
        }

        public static bool loginSample()
        {
            Boolean success = false;
            string username = "admin@arc902.1077.com";
            string password = "P@$$W0rD!AQauA8mYbflk3bDzoYuinKxh";
